...
export function decorateMCPCommand(command: Command, version: string) {
  command
      ...
      .option('--color-scheme <scheme>', 'color scheme to emulate: "dark", "light", "no-preference".', enumParser.bind(null, '--color-scheme', ['dark', 'light', 'no-preference']))
      ...
      .option('--forced-colors <mode>', 'forced colors mode to emulate: "active" or "none". Use "active" for high contrast mode testing.', enumParser.bind(null, '--forced-colors', ['active', 'none']))
      ...
      .option('--reduced-motion <value>', 'reduced motion to emulate: "no-preference" or "reduce".', enumParser.bind(null, '--reduced-motion', ['no-preference', 'reduce']))
